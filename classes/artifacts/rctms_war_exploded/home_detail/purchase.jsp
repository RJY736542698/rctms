...
<body>
   ...
   <div class="containerbox">
      ...
      <div class="menu"> 当前位置：<a href="index.jsp">首页</a> >> <a href="home_detail/purchase.jsp">国际采购</a> <span id="businessName"></span></div>     
    </div>
     <!--国际采购订单-->
     <div class="container" >
        <div class="row">           
            <div  class="col-md-9" id="purchase">   
                ...
                <div class="order" id="orderlist" > 
                    ...
                    <div class="row">     
                        ...
                        <div class="col-sm-8">
                            <h4><a href="<%=basePath%>home_detail/purchase_details.jsp">国际采购订单中文名称</a></h4>
            ...
            <div class="col-md-3 aside">
       			  <%@ include file="purchase_classify.jsp" %>
            </div>
        </div>
     </div>
     <!--底部-->
...
function getRowHtml(order){
	...
	if(order.tradeflag == "1"){
		...
		var strRow  ='<div class="row">'     
					...
					+'    </div>'  
					+'    <div class="col-sm-8">'
					+'        <h4><a href="<%=basePath%>home_detail/purchase_details.jsp?orderid='+order.orderid+'">'
